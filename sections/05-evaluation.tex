...
% 中：\item[RQ1（DSL 覆盖）] 一个翻译智能体能否为所有 607 条操作系统可执行指令生成 \sys{} 策略？
...
% 中：该翻译器为所有 607 条指令生成了策略，且它们全部编译通过。
...
% 中：仅语义的和内容指令被排除：前者没有系统可观察的效果，后者需要代码检查器而非操作系统级 IFC。
