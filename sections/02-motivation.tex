...
\paragraph{Are Instruction Files Behavioral Policies?}
% \paragraph{指令文件是行为策略吗？}
...
\paragraph{Which Policies Require OS-Level Enforcement?}
% \paragraph{哪些策略需要操作系统级执行？}

Given that most instruction-file content is policy, the next question is where enforcement should happen.
% 鉴于大多数指令文件内容是策略，下一个问题是执行应该在哪里发生。
...
\paragraph{What Context Is Needed to Instantiate Rules?}
% \paragraph{实例化规则需要什么上下文？}
