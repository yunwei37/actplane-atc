...
A validation script verified full source coverage and verbatim span matching,  with cross-checked by independent Claude and Codex agents.
% 一个验证脚本验证了完整的源覆盖和逐字跨度匹配, 并由独立的 Claude 和 Codex 智能体交叉检查。
A stratified sample of 100~statements was independently reviewed by human annotators and verified
the labels are correct, with cross-checked by independent Claude and Codex agents.
