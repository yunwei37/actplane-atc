...
This section provides background on agent harnesses and policy, then presents an empirical study of 64~projects to characterize the gap between policy intent and enforcement and motivate the design of \sys{}.
% 本节提供智能体 harness 和策略的背景，然后展示对 64 个项目的实证研究，以表征策略意图与执行之间的鸿沟，并推动 \sys{} 的设计。
...
We term their semantic meaning the agent's \emph{policy intent}.
% 我们将它们的语义含义称为智能体的 \emph{策略意图}。
