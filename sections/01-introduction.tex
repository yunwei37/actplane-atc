...
Harnesses surface these instructions to the model and rely on runtime
policy engines for deterministic compliance.

% ¶3: Empirical — the problem is pervasive; LLMs can't self-enforce
Many of these policies constrain system-level actions and demand deterministic enforcement. Our
...
\emph{AI agent intent and directives} is expressed through natural-language, but enforcement must decide over
\emph{system actions}: concrete commands, file operations, network
connections, and subprocess effects, 
plus project and task context. Runtime prompt, agent-action, and
tool-call policy
