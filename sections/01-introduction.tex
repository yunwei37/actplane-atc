...
programmability must not become an authority bypass, which requires a different threat model: traditional
sandboxes requires a trusted administrator authors policy, agents are
both policy author and constrained subject, they need a interfaceto add constraints safely while not weaken inherited policy set by trusted administrators or parent agents.
