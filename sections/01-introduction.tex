...
\texttt{bash~-c} wrapper, or a compiled binary; and at the repository level, 81\% of projects
contain cross-event directives that tool-level interception cannot
enforce. OS-level
