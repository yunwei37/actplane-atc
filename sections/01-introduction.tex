...
runtimes like claude code or codex, whether LLM
...
Static policy is also insufficient: the policy engine must define and
evaluate policies at runtime, allowing the agent to adapt them based on
project or task context. We find that 74\% of system-level directives
require project or task context that is absent from low-level OS events.
...
context, leaving the agent unable to follow the instructions or adapt
rules.
