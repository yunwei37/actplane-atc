...
Second, a \emph{semantic gap} between intent and system actions.
...
\item An \textbf{evaluation} on 607 OS-level policies from the
empirical study, measuring DSL expressiveness, LLM-based
natural-language-to-DSL translation correctness, system correctness
across bypass paths, per-event overhead, and feedback effectiveness on
repository-grounded OctoBench tasks.
\end{enumerate}
