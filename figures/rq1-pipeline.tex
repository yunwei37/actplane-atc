...
\node[box, fill=blue!10, right=2.2cm of nl, yshift=0.6cm] (regex) {Regex};
\node[box, fill=blue!10, right=2.2cm of nl, yshift=-0.6cm] (dsl) {DSL Policy};

% Enforcement (right column) — system names as labels
\node[box, fill=orange!15, right=1.6cm of regex, yshift=1.4cm, font=\normalsize\bfseries] (e1) {prompt-filter};
\node[box, fill=orange!15, right=1.6cm of regex, yshift=0.45cm, font=\normalsize\bfseries] (e2) {tool-regex};
\node[box, fill=orange!15, right=1.6cm of dsl, yshift=0.45cm, font=\normalsize\bfseries] (e3) {FIDES};
\node[box, fill=orange!15, below=0.28cm of e3, font=\normalsize\bfseries] (e4) {\sys{}};
